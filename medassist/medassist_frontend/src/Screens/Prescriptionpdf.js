...
import { Avatar, Button, FormControl, FormControlLabel, FormHelperText, FormLabel, Grid, InputLabel, MenuItem, Radio, RadioGroup, Select, TextField, Paper } from "@mui/material"
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            ...
            >
              ...
              <div style={{ fontWeight: 400, fontFamily: "kanit", fontSize: 12 }} >
                {doctor?.emailid} </div>
              
              <div style={{ fontWeight: 400, fontFamily: "kanit", fontSize: 12 }}>
                +91{doctor?.mobileno}{" "} </div>
            </div>
          </Grid>
          ...
          <Grid item xs={6}>
            ...
            >
              ...
              <div style={{fontWeight: "bold",fontFamily: "kanit",fontSize: 18,}}>
                {prescriptionlist?.patient?.username}</div>
              <div style={{ fontWeight: 400, fontFamily: "kanit", fontSize: 16 }}>
                {new Date().getFullYear() -
                 new Date(prescriptionlist?.patient?.userdob).getFullYear()}{" "}Year, Female</div>
              <div style={{ fontWeight: 400, fontFamily: "kanit", fontSize: 12 }}>
                +91{prescriptionlist?.patient?.usernum}{" "}
              </div>
            </div>
          </Grid>
