...
export default function PrescriptionInterface(props) {
  ...
  const [patientName, setPatientName] = useState(patientData.userregistration.username);
  ...
  const handleSubmit = async () => {
      ...
      var body={"answer":answerId,"patient":patientData.userregistration.useremail,"doctor":doctor.id,
