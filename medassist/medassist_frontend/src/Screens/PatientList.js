  ...
  function showPatientList() {
      return (
        ...
        <MaterialTable
          ...
          columns={[
            { title: 'EmailId',render:(rowData)=><div>{rowData.userregistration.useremail}</div>},
            { title: 'PhoneNumber',render:(rowData)=><div>{rowData.userregistration.usernum}</div>},
            { title: 'Name', render:(rowData)=><div>{rowData.userregistration.username}</div>},
