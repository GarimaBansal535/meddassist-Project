        ...
        <div style={{ display: 'flex', flexDirection: 'column', marginTop: '5%' }}>
          ...
          <div className={classes.box2}>
            <Grid container>
              ...
              <Grid item xs={11}>
                <div style={{ display: 'flex', marginBottom: 10, marginLeft: 15, color: '#154360', fontWeight: 'bold', fontSize: 25 }}>
                  Dr. {doctorData.doctorname}
                </div>
                <div>
                  <Button onClick={() => navigate('/patientdashboard', { state: { status: true } })}
                    style={{ variant: "contained", background: "#22a6b3", marginLeft: 15, borderRadius: 100, height: 40, color: "#ffff", fontSize: 15, paddingLeft: 30, paddingRight: 30, }}>Change Doctor </Button>
                </div>
              </Grid>
            </Grid>
          </div>
